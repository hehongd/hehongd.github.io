...
<style lang="scss" scoped>
    ...
    width: 500px;
    height: 180px;
    background: url('@/assets/scss1.png') no-repeat;
    background-size: 100%;
}
.imgs1 {
    width: 500px;
    height: 250px;
    background: url('@/assets/scss2.jpg') no-repeat;
    background-size: 100%;
}
.imgs2 {
    width: 500px;
    height: 250px;
    background: url('@/assets/scss3.png') no-repeat;
    background-size: 100%;
}
.imgs3 {
    width: 500px;
    height: 250px;
    background: url('@/assets/scss4.png') no-repeat;
    background-size: 100%;
}
.articleContanier {
    line-height: 1.8;
