<template>
  <div id="one">
    <h2>使用新的 CSS sin() 和 cos() 三角函数创建时钟</h2>
    <div style="padding: 10px;box-sizing: border-box;">来源地址：https://css-tricks.com/creating-a-clock-with-the-new-css-sin-and-cos-trigonometry-functions/</div>
    <div class="clock">
