import{d as m,u as v,c as b,r as s,a as D,b as j,e as h,f as n,g as i,v as u,h as k,i as p,j as y,k as a}from"./index.891e3832.js";const _={id:"one"},C=n("h1",null,"new Date()",-1),S={class:"articleContanier"},N=n("p",null,"\u4E00\u3001\u8BBE\u7F6E\u5468\u4E0B\u62C9\u6846",-1),L=n("code",null,`
                        // \u8BBE\u7F6E\u5468\u4E0B\u62C9\u6846\uFF0C\u4F20\u5165\u5E74\u4EFD\u7C7B\u578B\u5982\uFF1A'2023'
                    ...
                    `,-1),$=m({name:"WeekYear"}),V=Object.assign($,{setup(T){const w=v(),g=b(()=>w.bottomingOut),l=s(!1),r=s(!1),d=s(null),f=s(null);return(o,e)=>{const c=D("el-button");return j(),h("div",_,[C,n("article",S,[N,n("div",{class:"contanier",onMouseover:e[1]||(e[1]=t=>l.value=!0),onMouseleave:e[2]||(e[2]=t=>l.value=!1)},[i(k(c,{icon:p(y),class:"copy copyClass",onClick:e[0]||(e[0]=t=>o.copy(d.value))},null,8,["icon"]),[[u,l.value]]),n("pre",{class:"pre",ref_key:"refClone",ref:d},[a("                    "),L,a(`
