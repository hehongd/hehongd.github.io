import{d as D,u as w,c as _,r as s,a as h,b as C,e as t,f as u,v as i,g as f,h as d,i as a,k as M,l as m}from"./index.6e035b92.js";const k={id:"one"},b={class:"articleContanier"},T=t("p",null,"\u4E00.\u83B7\u53D6\u4E00\u5468\u6216\u4E00\u6708\u6570\u636E",-1),Y=t("code",null,`
                        // getDays(7) \u83B7\u53D6\u4E00\u5468\u6570\u636E
                        // getDays(30) \u83B7\u53D6\u4E00\u6708\u6570\u636E
                        getDays(day) {// \u83B7\u53D6\u5929\u6570
                            let arr = [];
                    ...
                    `,-1),F=D({name:"WyList"}),V=Object.assign(F,{setup(N){const y=w(),g=_(()=>y.bottomingOut),l=s(!1),r=s(!1),c=s(null),p=s(null);return(o,e)=>{const v=h("el-button");return M(),C("div",k,[t("article",b,[T,t("div",{class:"contanier",onMouseover:e[1]||(e[1]=n=>l.value=!0),onMouseleave:e[2]||(e[2]=n=>l.value=!1)},[u(f(v,{icon:d(m),class:"copy",onClick:e[0]||(e[0]=n=>o.copy(c.value))},null,8,["icon"]),[[i,l.value]]),t("pre",{class:"pre",ref_key:"refClone",ref:c},[a("                    "),Y,a(`
